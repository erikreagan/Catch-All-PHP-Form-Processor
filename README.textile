...
h3. $bccRecipient = "another-email@domainname.com";
...
h3. $finalDestination = "http://mywebsite.com/thankyou.html";

If $forwardUser is set to **TRUE** then this is the location you will forward them to. It can be as specific as above or it can be relative to your site. For example if you just want them to go to your homepage (assuming your homepage is somethinghere.com) you can set this value to "/".

h3. $subject = 'My PHP Form';

This is the subject of the email sent containing the results

h3. $subjectIsInForm = FALSE;

This is used if you are allowing the user to type in the subject

h3. $subjectField = "required-subject";

This is used to tell the script what the input field name is of the subject if the user is typing it in manually.

h3. $fromName = "Your Name";

This is the "From" Name when when sent.

h3. $fromNameIsInForm = TRUE;

This is the same function as $subjectIsInForm respective to the from name.

h3. $fromNameField = "required-your-name";

This is the same function as $subjectField respective to the from name field.

h3. $fromEmail = "handle@domainname.com";

This is the "From Email" address when sent.

h3. $fromEmailIsInForm = TURE;

This is the same function as $fromNameIsInField and $subjectIsInField respective to the from email field.

h3. $fromEmailField = "required-your-email";

This is the same function as $fromNameField and $subjectField respective to the from email field.

h3. $includeTimestamp = TRUE;

If set to true this adds the date and time at the end of the form results once emailed.

h3. $includeBlankFields = TRUE;
...
+*2.0 Released September 26th, 2009*+
